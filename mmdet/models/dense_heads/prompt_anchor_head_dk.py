...
class StaRPNHead(nn.Module):
    ...
    def forward(self, features: List[torch.Tensor]):
        ...
        for level, x in enumerate(features):
            ...
            objectnesses = self.objectness_logits(x)
            pred_objectness_logits.append(objectnesses.sigmoid())

        return pred_objectness_logits, pred_anchor_deltas


@HEADS.register_module()
class PromptAnchorHeadDK(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        super(PromptAnchorHeadDK, self).__init__(init_cfg)
        ...
        self.main_head = StaRPNHead(self.in_channels, self.num_levels)
        self.aux_head = StaRPNHead(self.in_channels, self.num_levels)
    ...
    def forward_train(self,
        ...
        gt_labels = [gt_label * 0 for gt_label in gt_labels] # class-agnostic
        ...
        return losses, proposals, proposal_feats, imgs_whwh
    ...
    def simple_test_rpn(self, x, img_metas):
        ...
        return proposals, proposal_feats, imgs_whwh
