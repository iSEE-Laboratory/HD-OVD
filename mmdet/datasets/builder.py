...
def build_dataset(cfg, default_args=None):
    from .dataset_wrappers import (ClassBalancedDataset, ConcatDataset,
                                   MultiImageMixDataset, RepeatDataset, myClassBalancedDataset)
    ...
    elif cfg['type'] == 'myClassBalancedDataset':
        dataset = myClassBalancedDataset(
            build_dataset(cfg['dataset'], default_args), cfg['repeat_times'])
...
def build_dataloader(dataset,
    ...
    if runner_type == 'IterBasedRunner' or runner_type == 'IterOVDRunner':
