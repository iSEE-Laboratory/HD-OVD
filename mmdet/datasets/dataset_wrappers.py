...
class myClassBalancedDataset:
    ...
    def __init__(self, dataset, repeat_times):
        ...
        repeat_factors = self._get_repeat_factors(dataset, repeat_times)
        repeat_indices = []
    ...
    def _get_repeat_factors(self, dataset, repeat_times):
    ...
    def __getitem__(self, idx):
        while True:
            try:
                ...
                idx = np.random.randint(len(self.repeat_indices))
