...
# model, preprocess = clip.load("CLIP_RN50.pt", device=device)
# model.eval()
...
imagenet_templates = [
    ...
    'a sculpture of the {}.',
    'a bright photo of the {}.',
    'a cropped photo of an {}.',
    'a plastic {}.',
    'a photo of the dirty {}.',
    'a jpeg corrupted photo of an {}.',
    'a blurry photo of the {}.',
    'a photo of the {}.',
    'a good photo of the {}.',
    'a rendering of the {}.',
    ...
    'a photo of a nice {}.',
    'a photo of a weird {}.',
    'a blurry photo of an {}.',
    'a cartoon {}.',
    'art of an {}.',
    'a sketch of the {}.',
    'a embroidered {}.',
    'a pixelated photo of an {}.',
    'itap of the {}.',
    'a jpeg corrupted photo of the {}.',
    'a good photo of an {}.',
    'a plushie {}.',
...
with torch.no_grad():
    texts = [template.format('object') for template in imagenet_templates] #format with class
    texts = clip.tokenize(texts).to(device)
    text_features = model.encode_text(texts)
    text_features = text_features / text_features.norm(dim=1, keepdim=True)
...
# for n in new_names:
#     print(n)
#     inds.append(ori_names.index(n))


# inds = torch.tensor(inds)

# x = torch.load('coco_cross_data_category_embeddings.pt', 'cpu')
# print(x.shape)
# x = x[inds]
torch.save(text_features, 'obj_manual_category_embeddings_r50.pt')
